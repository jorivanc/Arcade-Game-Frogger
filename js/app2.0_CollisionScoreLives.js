...
class Enemy {
  constructor(){
    ...
    //X position will be initialized with a number between 0 and -600 so the whole enemy is behin the begining of the screen
    ...
    // Enemy's SPEED: will be a random speed between 50 and 450
  ...
  resetEnemy(){
    ...
    // console.log("deltaDifficulty : "+deltaDifficulty);
  }
